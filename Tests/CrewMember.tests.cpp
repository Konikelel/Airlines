...
TEST(CrewMemberClass, setters) {
    ...
    // setCompany
    // SETTING ONLY COMPANY WITHOUT FLIGHTS
    ...
    // ADD FLIGHTS AND CHANGE TO THE SAME COMPANY
    crewMember.setCompany(pCompany1);
    crewMember.addFlight(flight1);
    crewMember.addFlight(flight2);
    crewMember.setCompany(pCompany1);
